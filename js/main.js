...
$('body').on(clickHandler, '.science', function (event) {
...
$('body').on(clickHandler, '[data-type="page-transition"]', function (event) {
...
$('body').on(clickHandler, '.plusminus', function (event) {
...
$('body').on(clickHandler, '.addmod', function (event) {
    if ($(this).text() == "+") {
        $(this).text("-");
